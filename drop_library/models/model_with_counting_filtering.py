...
@Model.register("naqanetic_filtering")
class NumericallyAugmentedQaNetImprovedCountingAndFiltering(Model):
    """
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        self._threshold = torch.nn.Threshold(threshold, 0.0)
    ...
    def forward(self,  # type: ignore
        ...
        if "counting" in self.answering_abilities:
            ...
            count_number_probs = torch.ceil(self._threshold(count_number_probs))
